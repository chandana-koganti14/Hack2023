...
$sql="INSERT INTO  tblen(FullName,EmailId,Subject,Description) VALUES(:fname,:email,:subject,:description)";
...
<html>
<head>
<title>VNITSW | Learning Portal</title>
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">NIRULA'S HUB</h1>
	</div>
</div>
